...
use MGD\AdminBundle\Form\RolType;
use MGD\AdminBundle\Form\RolFilterType;
...
class RolController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('MGDFrameworkBundle:Rol')->createQueryBuilder('e');
    ...
    */
     ...
     * @Method("POST")
     * @Template("MGDAdminBundle:Rol:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MGDFrameworkBundle:Rol')->find($id);
     ...
     * @Method("PUT")
     * @Template("MGDAdminBundle:Rol:edit.html.twig")
     */
