...
use MGD\BasicBundle\Entity\Noticia;
use MGD\AdminBundle\Form\NoticiaType;
use MGD\AdminBundle\Form\NoticiaFilterType;
...
class NoticiaController extends Controller
{
	...
	protected function filter()
	{
		...
		$filterForm = $this->createForm(new NoticiaFilterType());
		$em = $this->getDoctrine()->getManager();
		$queryBuilder = $em->getRepository('MGDBasicBundle:Noticia')->createQueryBuilder('e');
		...
		if ($request->get('filter_action') == 'filter') {
			...
			if ($session->has('NoticiaControllerFilter')) {
				...
				try{
					$filterForm = $this->createForm(new NoticiaFilterType(), $filterData);
				}catch (\Exception $e){
					// empty values
	...
	protected function paginator($queryBuilder)
	{
		...
		{
			return $me->generateUrl('noticia', array('page' => $page));
		};
	 ...
	 * @Method("POST")
	 * @Template("MGDAdminBundle:Noticia:new.html.twig")
	 */
	...
	public function showAction($id)
	{
		...
		$entity = $em->getRepository('MGDBasicBundle:Noticia')->find($id);
	 ...
	 * @Method("PUT")
	 * @Template("MGDAdminBundle:Noticia:edit.html.twig")
	 */
